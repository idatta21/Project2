...
date: "10/15/2021"
params:
  channel: data_channel_is_bus # this is here for the initial knit of this .RMD file. The separate render code will overwrite it later.
---
...
We have created 4 models - 2 linear regression model,1 Random Forest Model and 1 Boosted tree model. Here in this given data set, we are trying to predict the number of shares of a news article .
We are comparing four model with respect to their RMSE. Model with lowest RMSE works best.
```{r comparison}

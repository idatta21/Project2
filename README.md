...
![](./images/unnamed-chunk-46-1.png)<!-- --> To find correlation
...
```
    ...
    ## timedelta                       -0.06       0.01                 0.04         0.10
    ## n_tokens_title                  -0.02       0.04                -0.09         0.00
    ## n_tokens_content                 0.24       0.14                 0.02         0.17
    ## n_unique_tokens                 -0.22      -0.05                 0.31        -0.14
    ## n_non_stop_words                 0.03       0.00                 0.73        -0.06
    ## n_non_stop_unique_tokens        -0.27      -0.10                 0.33        -0.13
    ## num_hrefs                        0.27       0.15                 0.16         0.20
    ## num_self_hrefs                   0.20       0.05                 0.01         0.03
    ## num_imgs                         1.00      -0.02                 0.03         0.08
    ## num_videos                      -0.02       1.00                -0.03         0.08
    ## average_token_length             0.03      -0.03                 1.00        -0.02
    ## num_keywords                     0.08       0.08                -0.02         1.00
    ## kw_min_min                      -0.02       0.03                -0.01         0.03
    ## kw_max_min                       0.00       0.03                 0.00         0.07
    ## kw_avg_min                      -0.01       0.02                 0.01         0.09
    ## kw_min_max                      -0.02       0.05                -0.03        -0.27
    ## kw_max_max                       0.05      -0.04                 0.00        -0.02
    ## kw_avg_max                       0.01       0.07                -0.06        -0.42
    ##                              kw_min_min kw_max_min kw_avg_min kw_min_max kw_max_max
    ## timedelta                          0.59       0.01       0.11      -0.12      -0.64
    ## n_tokens_title                    -0.05      -0.03      -0.05       0.03       0.06
    ## n_tokens_content                  -0.07       0.02       0.03      -0.04       0.08
    ## n_unique_tokens                    0.06      -0.01      -0.02       0.05      -0.07
    ## n_non_stop_words                  -0.01       0.00       0.01      -0.01       0.00
    ## n_non_stop_unique_tokens           0.04      -0.01      -0.02       0.04      -0.05
    ## num_hrefs                         -0.08       0.02       0.02      -0.04       0.09
    ## num_self_hrefs                    -0.09      -0.02      -0.04      -0.02       0.10
    ## num_imgs                          -0.02       0.00      -0.01      -0.02       0.05
    ## num_videos                         0.03       0.03       0.02       0.05      -0.04
    ## average_token_length              -0.01       0.00       0.01      -0.03       0.00
    ## num_keywords                       0.03       0.07       0.09      -0.27      -0.02
    ## kw_min_min                         1.00       0.00       0.10      -0.08      -0.86
    ## kw_max_min                         0.00       1.00       0.98      -0.03       0.00
    ## kw_avg_min                         0.10       0.98       1.00      -0.07      -0.09
    ## kw_min_max                        -0.08      -0.03      -0.07       1.00       0.08
    ## kw_max_max                        -0.86       0.00      -0.09       0.08       1.00
    ## kw_avg_max                        -0.65      -0.03      -0.13       0.44       0.67
    ##                              kw_avg_max kw_min_avg kw_max_avg kw_avg_avg
    ## timedelta                         -0.55      -0.22      -0.05      -0.19
    ## n_tokens_title                     0.06       0.01       0.01       0.02
    ## n_tokens_content                  -0.07       0.03       0.01       0.04
    ## n_unique_tokens                    0.06      -0.03      -0.01      -0.03
    ## n_non_stop_words                  -0.06      -0.01      -0.05      -0.07
    ## n_non_stop_unique_tokens           0.03      -0.04      -0.02      -0.04
    ## num_hrefs                         -0.03       0.05       0.03       0.08
    ## num_self_hrefs                     0.05       0.05      -0.01       0.01
    ## num_imgs                           0.01       0.05       0.00       0.03
    ## num_videos                         0.07       0.03       0.06       0.11
    ## average_token_length              -0.06      -0.03      -0.07      -0.09
    ## num_keywords                      -0.42      -0.36       0.10       0.00
    ## kw_min_min                        -0.65      -0.18      -0.07      -0.21
    ## kw_max_min                        -0.03      -0.01       0.53       0.44
    ## kw_avg_min                        -0.13      -0.04       0.51       0.41
    ## kw_min_max                         0.44       0.38       0.05       0.19
    ## kw_max_max                         0.67       0.20       0.08       0.23
    ## kw_avg_max                         1.00       0.46       0.11       0.36
    ##                              self_reference_min_shares self_reference_max_shares
    ## timedelta                                        -0.01                     -0.02
    ## n_tokens_title                                   -0.01                      0.00
    ## n_tokens_content                                 -0.03                      0.00
    ## n_unique_tokens                                   0.04                      0.03
    ## n_non_stop_words                                  0.01                      0.01
    ## n_non_stop_unique_tokens                          0.03                      0.02
    ## num_hrefs                                        -0.01                      0.03
    ## num_self_hrefs                                   -0.03                      0.10
    ## num_imgs                                         -0.01                      0.00
    ## num_videos                                        0.00                      0.09
    ## average_token_length                             -0.01                     -0.03
    ## num_keywords                                      0.00                      0.01
    ## kw_min_min                                       -0.03                     -0.05
    ## kw_max_min                                        0.02                      0.06
    ## kw_avg_min                                        0.02                      0.05
    ## kw_min_max                                        0.00                      0.05
    ## kw_max_max                                        0.03                      0.05
    ## kw_avg_max                                        0.06                      0.12
    ...
    ## timedelta                      0.00   0.06  -0.06  -0.10   0.06               -0.01
    ## n_tokens_title                -0.07   0.01   0.05   0.03   0.04               -0.01
    ## n_tokens_content               0.14  -0.07  -0.01  -0.06  -0.11                0.17
    ## n_unique_tokens               -0.12   0.06   0.01   0.01   0.10                0.00
    ## n_non_stop_words               0.04   0.01   0.03  -0.17   0.02                0.32
    ## n_non_stop_unique_tokens      -0.05   0.05   0.02  -0.06   0.06                0.10
    ## num_hrefs                      0.10  -0.07  -0.03   0.00  -0.07                0.12
    ## num_self_hrefs                -0.05   0.01  -0.03   0.00   0.09                0.00
    ## num_imgs                      -0.07   0.03   0.00   0.07   0.03                0.04
    ## num_videos                    -0.01  -0.02  -0.05   0.20  -0.06                0.07
    ## average_token_length           0.08  -0.02   0.04  -0.15  -0.03                0.13
    ## num_keywords                  -0.10   0.01   0.02   0.04   0.09                0.06
    ## kw_min_min                    -0.01   0.05  -0.05  -0.04   0.03               -0.01
    ## kw_max_min                     0.00   0.00  -0.01   0.04  -0.03                0.04
    ## kw_avg_min                     0.02   0.01  -0.01   0.02  -0.03                0.04
    ## kw_min_max                     0.04  -0.03  -0.03   0.04  -0.04                0.01
    ## kw_max_max                     0.01  -0.05   0.04   0.05  -0.03                0.01
    ## kw_avg_max                     0.04  -0.05  -0.01   0.17  -0.12                0.00
    ##                              global_sentiment_polarity global_rate_positive_words
    ## timedelta                                         0.08                       0.10
    ## n_tokens_title                                   -0.02                      -0.01
    ## n_tokens_content                                  0.08                       0.18
    ## n_unique_tokens                                  -0.01                      -0.06
    ## n_non_stop_words                                  0.10                       0.16
    ## n_non_stop_unique_tokens                          0.02                       0.01
    ## num_hrefs                                         0.12                       0.13
    ## num_self_hrefs                                   -0.02                      -0.02
    ## num_imgs                                          0.02                      -0.02
    ## num_videos                                        0.03                       0.09
    ## average_token_length                              0.12                       0.13
    ## num_keywords                                      0.12                       0.13
    ## kw_min_min                                        0.04                       0.05
    ## kw_max_min                                        0.01                       0.02
    ## kw_avg_min                                        0.02                       0.03
    ## kw_min_max                                       -0.03                       0.00
    ## kw_max_max                                       -0.04                      -0.05
    ## kw_avg_max                                       -0.07                      -0.08
